...
//       actionData: this.sanitizeData(logData.action, logData.maskedAction),
//       feedback: this.sanitizeData(logData.feedback, logData.maskedFeedback),
...
//   /**
//    * Extract action name from data or use description
//    */
//   private extractActionName(action: any, description: string): string {
...
//    * Removes sensitive fields if masked
//    */
//   private sanitizeData(data: any, isMasked: boolean) {
//     if (!data) {
//       return null;
//     }
